...
const configVariables: ConfigVariables = {
  ...
  email: {
    ...
    resetPasswordSubject: {
      type: "string",
      defaultValue: "Share It password reset",
    },
    ...
    inviteSubject: {
      type: "string",
      defaultValue: "Share It invite",
    },
    inviteMessage: {
      type: "text",
      defaultValue:
        "Hey!\n\nYou were invited to Share It. Click this link to accept the invite: {url}\n\nYour password is: {password}\n\nShare It 💪",
    },
  },
  smtp: {
    enabled: {
  ...
  datasources: {
    db: {
      url:
        ...
        "file:../data/share-it.db?connection_limit=1",
    },
  },
});
